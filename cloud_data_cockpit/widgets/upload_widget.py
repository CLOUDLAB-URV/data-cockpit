...
import io
import os
from ..aws_utils import list_files  # Adjust this import as needed
...
class UploadWidget:
    ...
    def on_upload_click(self, b):
        """Upload files to S3 using the selected bucket and optional folder, and update slider description based on file format."""
        with self.output:
            clear_output()
            ...
            try:
                ...
                if s3_uris:
                    ...
                    # Update slider description based on file extension of the first uploaded file
